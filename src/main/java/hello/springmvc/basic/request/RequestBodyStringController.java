...
public class RequestBodyStringController {
    ...
    public void requestBodyString(
        ...
        // stream은 바이트 코드이기에 이를 특정 인코딩 방식(e.g. UTF_8)으로 인코딩해서 가져와야한다.
    ...
    /**
     * RequestEntity, ResponseEntity는 둘다 Entity를 상속받음
     */
    @PostMapping("/request-body-string-v3-1")
    public HttpEntity<String> requestBodyStringV3_1(
